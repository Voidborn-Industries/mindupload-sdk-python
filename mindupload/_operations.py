...
class MindUpload(_BaseClient):
    ...
    def invoke_external_clone(self, *, preferred_language: Optional[str] = None, access_token: str, installation_id: str, external_subject: str, clone_id: str, text: str, idempotency_key: str) -> Result:
        ...
        Full parameter reference: https://docs.mindupload.app
        """
        return self._request("invoke_external_clone", {"preferred_language": preferred_language, "access_token": access_token, "installation_id": installation_id, "external_subject": external_subject, "clone_id": clone_id, "text": text, "idempotency_key": idempotency_key})
