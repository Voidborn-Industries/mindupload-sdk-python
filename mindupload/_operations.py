...
class MindUpload(_BaseClient):
    ...
    def exchange_external_authorization(self, *, preferred_language: Optional[str] = None, device_code: str) -> Result:
        ...
        Returns:
            Result fields: success, error_message, status, access_token, refresh_token, token_type, grant_id, scopes, clone_ids, access_token_expires_at, expires_at, poll_interval.
    ...
    def refresh_external_authorization(self, *, preferred_language: Optional[str] = None, refresh_token: str, installation_id: str, external_subject: str) -> Result:
        ...
        Returns:
            Result fields: success, error_message, status, access_token, refresh_token, token_type, grant_id, scopes, clone_ids, access_token_expires_at, expires_at.
