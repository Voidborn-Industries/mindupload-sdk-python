...
class MindUpload(_BaseClient):
    ...
    def create_external_authorization_request(self, *, preferred_language: Optional[str] = None, idempotency_key: str, installation_id: str, external_subject: str, installation_label: Optional[str] = None, external_identity_label: Optional[str] = None, requested_scopes: List[Literal['clone:invoke', 'clone:learn']]) -> Result:
